...
- starter 게시글에 짧은 기본 댓글을 함께 생성하여 초기 참여 흐름을 확인할 수 있도록 개선
- 게시글 상세 SEO에서 본문 요약과 대표 이미지를 OpenGraph 메타데이터로 제공하도록 개선

### Changed

- 대댓글 작성 시 게시글 작성자와 부모 댓글 작성자에게 필요한 알림을 보내고, 같은 사용자가 중복 수신하지 않도록 개선
